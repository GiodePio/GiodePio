      ...
      <div style={{ maxWidth: 400, margin: '0 auto' }}>
        <div style={{ background: '#111218', border: '1px solid #22c55e', borderRadius: 14, padding: 32, position: 'relative' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 6 }}>
            <span style={{ fontSize: 14, color: colors.textDim, fontWeight: 600 }}>👑</span>
            <span style={{ fontSize: 14, color: colors.textDim, fontWeight: 600 }}>Ultimate Grabs</span>
          </div>
          ...
          <button disabled style={{ width: '100%', marginTop: 24, padding: '14px 0', background: colors.green, color: '#000', border: 'none', borderRadius: 10, fontSize: 14, fontWeight: 700, opacity: 0.5, cursor: 'not-allowed' }}>Upgrade for $9.99/mo</button>
        </div>
      </div>
    </section>
  );
